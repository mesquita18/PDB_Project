...
urlpatterns = [
    ...
    # Novas rotas: editar e deletar disciplinas
    path('editar-disciplina/<str:cod_disciplina>/', views.editar_disciplina, name='editar_disciplina'),
    path('deletar-disciplina/<str:cod_disciplina>/', views.deletar_disciplina, name='deletar_disciplina'),
    
    # Novas rotas: editar e deletar turmas
